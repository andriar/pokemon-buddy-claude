...
This writes `trainer-card.html` and `trainer-card-og.svg` (1200×630 social-share image) to the current working directory. Print the output verbatim.
...
3. Briefly tell the user:
   ...
   - `./trainer-card-og.svg` is a 1200×630 social-share image wired into the HTML via OpenGraph meta tags — when the HTML is hosted (GitHub Pages, Vercel, etc.), link previews on Discord/Slack/Mastodon pull it automatically.
   - Drag the HTML into Discord/Slack as a file attachment, or host it on GitHub Pages.
